...
## 1. [3D Shape Classification](./ClsPartSeg)

## 2. 3D Part Segmentation

## 3. 2D/3D Material Segmentation

## 4. 2D Material Tagging

## 5. 2D Shape Classification

## 6. Sim2Real Transferring
