...
#SBATCH -J PRET_CAN_C4
#SBATCH -o /home/slimhy/logs/shape_classifier/PRET_CAN_C4.out
#SBATCH -e /home/slimhy/logs/shape_classifier/PRET_CAN_C4.err
...
python main.py --num-workers 4 \
    --use-tmp \
    --exp-name PRET_CAN_C4 \
    --exp-tag PRET-CAN \
    --root-url /var/remote/lustre/scratch/project/k1546/shards/ \
    --models-dir /ibex/scratch/slimhy/models/shape_classifier/PRET_CAN_C4/ \
    --batch-size 64 \
    --nbatches 10000 \
    --num-classes 41 \
