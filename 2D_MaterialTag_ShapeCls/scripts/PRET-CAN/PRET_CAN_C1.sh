...
#SBATCH -J PRET_CAN_C1
#SBATCH -o /home/slimhy/logs/shape_classifier/PRET_CAN_C1.out
#SBATCH -e /home/slimhy/logs/shape_classifier/PRET_CAN_C1.err
...
python main.py --num-workers 4 \
    ...
    --models-dir /ibex/scratch/slimhy/models/shape_classifier/PRET_CAN_C1/ \
    --batch-size 64 \
    --nbatches 10000 \
    --num-classes 41 \
