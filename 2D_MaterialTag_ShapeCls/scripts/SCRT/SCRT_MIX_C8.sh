...
#SBATCH -J SCRT_MIX_C8
#SBATCH -o /home/slimhy/logs/shape_classifier/SCRT_MIX_C8.out
#SBATCH -e /home/slimhy/logs/shape_classifier/SCRT_MIX_C8.err
...
python main.py --num-workers 4 \
    --use-tmp \
    --exp-name SCRT_MIX_C8 \
    --exp-tag SCRT-MIX \
    --root-url /var/remote/lustre/scratch/project/k1546/shards/ \
    --models-dir /ibex/scratch/slimhy/models/shape_classifier/SCRT_MIX_C8/ \
    --batch-size 64 \
    --nbatches 10000 \
    --num-classes 41 \
