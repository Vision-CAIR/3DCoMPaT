...
if __name__ == '__main__':
    ...
    data_root = '~/3d-few-shot/3dcompat/3dcompat/baselines/model_classifier/processed_models'
    train_data = compat3D(dataPathPrefix=data_root, aug=True, split='train', memCacheInit=True, voxelSize=0.05)
    val_data = compat3D(dataPathPrefix=data_root, aug=False, split='val', memCacheInit=True, voxelSize=0.05,
                        eval_all=True)
    manual_seed = 123
